...
parser.add_argument('--bs', default=3, type=int, help='batchsize')
...
parser.add_argument('--maskname', default='mask_1DRU_512x512_R3', type=str, help='mask name')
